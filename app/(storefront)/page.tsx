...
export default async function HomePage() {
  ...
  const chapterCards = snapshot.chapters
        ...
        <div className="shell">
          <div className={styles.sectionHeading}>
            ...
            <div className={styles.headingLinks}>
              ...
              <Link className="text-link" href="/shop">瀏覽全部 {products.length} 件</Link>
            </div>
          </div>
      ...
      <section className={styles.chapters} aria-labelledby="chapters-title">
        ...
        <div className={styles.chapterGrid}>
          {chapterCards.map((chapter, index) => (
            <Link className={styles.chapter} href={chapter.href} key={chapter.code}>
              {chapter.image ? (
                <FocusedImage
                  src={chapter.image}
